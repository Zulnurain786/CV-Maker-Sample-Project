            ...
            <div className="p-2">
             <ul>
                <li className='p-3 border-b border-gray-100'>
                 <button onClick={toggleRenameModal}  type="button"  className={`${styles['jetzt-btn']}`}>Rename</button>
                ...
                <li className='p-3'>
                  <a href={`/account/editapplication?id=${pdfid}`}><div style={{ gap: '4px', alignItems: 'center', display: 'flex' }}><FaEdit /> Edit</div></a>
                </li>
                <li className='p-3'>
