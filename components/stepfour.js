...
import PdfDesignPage4 from "./PdfDesignPage4";
import { useState } from "react";

const step = ({residencepermit,fläche,anzahlderzimmer,showresidencepermit,handleChange,setComponents,vorname,nachname,email,tel,selectedImg}) => {
  const [selectedRadio7, setSelectedRadio7] = useState('Ja');
  // const [showresidencepermit, setShowresidencepermit] = useState(false);
  const radiohandle = (value, id) => {
    if (id === "r7") {
      setSelectedRadio7(value);
    }
    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <div className={`grid grid-cols-2 gap-4 mt-7 mb-3 ${selectedRadio7 === "Ja" ? "block" : "hidden" }`}>
            <div className="...">
          ...
          <div className={`grid grid-cols-8 gap-4 mt-9 ${selectedRadio7 === "Ja" ? "block" : "hidden" }`}>
            <div className="col-span-8 text-center ...">
        ...
        <div className={`${selectedRadio7 === "Ja" ? "block" : "hidden" }`}>
          <PdfDesignPage4  
            vorname={vorname}
            nachname={nachname}
            email={email}
