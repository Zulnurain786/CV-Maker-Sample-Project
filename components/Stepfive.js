...
import PdfDesignPage5 from "./PdfDesignPage5";
import { useState,useRef } from "react";

const Stepfive = ({shortvideo,identificationdocument,showidentificationdocument,showshortvideo,handleChange,setComponents,vorname,nachname,email,tel,selectedImg
}) => {
  ...
  const showshortvideoRef = useRef();
  const identificationdocumentRef = useRef();
    ...
    const validation = () =>{
        ...
        if (!showshortvideo) newErrors.showshortvideo = 'showshortvideo is required';
        if (!identificationdocument) newErrors.identificationdocument = 'identificationdocument is required';
              ...
              <div className={`${styles["file-upload"]}`}>
                ...
                >
                  ...
                  <input
                    type="file"
                    id="attach7"
                    useRef={identificationdocumentRef}
